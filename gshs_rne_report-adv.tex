...
% vs code에서 에러나는 것을 해결하기 위해 아랫줄 preamble에서 옮겨옴.
...
\begin{document}
	...
	\include{sub/introduction} % 서론
	\include{sub/theoritical_background} % 이론적 배경
	\include{sub/method_of_the_study} % 연구 과정
	\include{sub/result_and_discussion} % 결과 및 토의
	\include{sub/conclusion} % 결론
	% \include{sub/further_study} % 추후 연구
	\include{sub/appendix} % 부록
